...
GLOBAL_LIST_INIT(marine_clothes_listed_products, list(
		...
		/obj/item/storage/backpack/marine/satchel/molle = list(CAT_BAK, "MOLLE Satchel", 0, "orange"),
		/obj/item/storage/backpack/marine/standard/molle = list(CAT_BAK, "MOLLE Backpack", 0, "black"),
		/obj/item/storage/backpack/marine/satchel/green = list(CAT_BAK, "Green Satchel", 0, "orange"),
...
GLOBAL_LIST_INIT(engineer_clothes_listed_products, list(
		...
		/obj/effect/essentials_set/xenonauten_medium = list(CAT_AMR, "Xenonauten medium armor kit", 0, "orange"),
		/obj/effect/essentials_set/xenonauten_heavy = list(CAT_AMR, "Xenonauten heavy armor kit", 0, "orange"),
		/obj/item/storage/backpack/marine/satchel/tech = list(CAT_BAK, "Technician Satchel", 0, "orange"),
		/obj/item/storage/backpack/marine/tech = list(CAT_BAK, "Technician Backpack", 0, "black"),
		/obj/item/storage/backpack/satchel/eng = list(CAT_BAK, "Industrial Satchel", 0, "orange"),
...
GLOBAL_LIST_INIT(medic_clothes_listed_products, list(
		...
		/obj/item/clothing/suit/storage/marine/robot = list(CAT_AMR, "Combat robot medium armor plating", 0, "black"),
		/obj/item/clothing/suit/storage/marine/robot/heavy = list(CAT_AMR, "Combat robot heavy armor plating", 0, "black"),
		/obj/item/storage/backpack/marine/satchel/corpsman = list(CAT_BAK, "Corpsman Satchel", 0, "orange"),
		/obj/item/storage/backpack/marine/corpsman = list(CAT_BAK, "Corpsman Backpack", 0, "black"),
		/obj/item/storage/backpack/satchel/med = list(CAT_BAK, "Medical Satchel", 0, "orange"),
		/obj/item/storage/backpack/corpsman = list(CAT_BAK, "Medical Backpack", 0, "black"),
		/obj/item/armor_module/storage/uniform/brown_vest = list(CAT_WEB, "Tactical brown vest", 0, "orange"),
...
GLOBAL_LIST_INIT(leader_clothes_listed_products, list(
		...
		/obj/item/storage/backpack/marine/standard = list(CAT_BAK, "Backpack", 0, "black"),
		/obj/item/storage/backpack/marine/satchel/molle = list(CAT_BAK, "MOLLE Satchel", 0, "black"),
		/obj/item/storage/backpack/marine/standard/molle = list(CAT_BAK, "MOLLE Backpack", 0, "black"),
		/obj/item/storage/backpack/marine/satchel/green = list(CAT_BAK, "Green Satchel", 0, "black"),
		/obj/item/storage/holster/blade/machete/full = list(CAT_BAK, "Machete scabbard", 0, "black"),
